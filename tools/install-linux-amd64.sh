...
wget https://github.com/brownhounds/migoro/releases/download/0.1.0/migoro-linux-amd64


log_message_info "🔧 Installing..."
chmod +x ./migoro-linux-amd64
...
mv ./migoro-linux-amd64 $HOME/.local/bin/migoro
